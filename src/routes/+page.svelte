<script lang="ts">
	...
	import { SectionDividerVariant, GeometricBackground } from '$lib/components/ui';
...
<div
	class="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth bg-slate-50 dark:bg-slate-900 relative"
>
	<!-- 背景层 -->
	<div class="absolute inset-x-0 top-0 h-[320vh] z-0 pointer-events-none">
		<!-- Tech Grid Background -->
		<div
			class="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"
		/>
		<div
			class="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(100,116,139,0.12),rgba(255,255,255,0))]"
		/>
